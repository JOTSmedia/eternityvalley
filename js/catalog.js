...
// ---------- Charitable giving ----------
// A share of every gift goes to a real animal charity — chosen by
// the memorial's owner, or by the giver when the owner hasn't picked.
export const GIFT_CHARITY_SHARE = 0.10;   // 10% of every gift
export const CHARITIES = [
  { id: 'ch_aspca',   name: 'ASPCA' },
  { id: 'ch_bestfr',  name: 'Best Friends Animal Society' },
  { id: 'ch_humane',  name: 'Humane Society of the U.S.' },
  { id: 'ch_local',   name: 'Local shelters near you' },
  { id: 'ch_wild',    name: 'Wildlife rescue network' },
  { id: 'ch_vetcare', name: 'Emergency vet-care fund for low-income families' },
];
export const charityName = (id) => CHARITIES.find(c => c.id === id)?.name || null;

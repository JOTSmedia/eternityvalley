...
import { OrbitControls } from 'three/addons/controls/OrbitControls.js?v=7';
import { Sky } from 'three/addons/objects/Sky.js?v=7';
import { Water } from 'three/addons/objects/Water.js?v=7';
import { Lensflare, LensflareElement } from 'three/addons/objects/Lensflare.js?v=7';
import { EffectComposer } from 'three/addons/postprocessing/EffectComposer.js?v=7';
import { RenderPass } from 'three/addons/postprocessing/RenderPass.js?v=7';
import { UnrealBloomPass } from 'three/addons/postprocessing/UnrealBloomPass.js?v=7';
import { ShaderPass } from 'three/addons/postprocessing/ShaderPass.js?v=7';
import { OutputPass } from 'three/addons/postprocessing/OutputPass.js?v=7';
import { FXAAShader } from 'three/addons/shaders/FXAAShader.js?v=7';
import { GTAOPass } from 'three/addons/postprocessing/GTAOPass.js?v=7';
import { SSRPass } from 'three/addons/postprocessing/SSRPass.js?v=7';
import { BokehPass } from 'three/addons/postprocessing/BokehPass.js?v=7';
import { mergeGeometries as _rawMergeGeometries } from 'three/addons/utils/BufferGeometryUtils.js?v=7';
import { RGBELoader } from 'three/addons/loaders/RGBELoader.js?v=7';
import { CSM } from 'three/addons/csm/CSM.js?v=7';
...
import { WORLD, DISTRICTS, ROADS, RIVER, RIVER_INLET, RIVER_OUTLET, terrainHeight, backgroundMountainElevation, distToRoads, distToRiver, getRiverInfo, riverWaterElevation, fbm, ridgeNoise, mulberry32, SIZE_DIMS } from './terrain.js?v=7';
import { getSeason, SEASON_STYLE, getDayPhase, PHASES, MOODS, fetchWeather } from './ambience.js?v=7';
import { Surfaces, waterNormalTexture, textures, material, createBotanicalFoliageMaterial, clearCache } from './materials.js?v=7';
import { icon, speciesIcon, speciesKey } from './icons.js?v=7';
import { charityName } from './catalog.js?v=7';
import { DRONE_TOUR_LANDMARKS } from './tour.js?v=7';
import { buildGrandBoulevard, buildSecondaryRoad } from './roads.js?v=7';
...
export class WorldLighting {
  ...
  _composer() {
    ...
    if (!isMobile) {
      ...
      // composer.addPass(bokehPass); // DISABLED: Static focus of 1.0 blurred the entire scene
    }

...
import { WORLD, DISTRICTS, ROADS, RIVER, RIVER_INLET, RIVER_OUTLET, terrainHeight, backgroundMountainElevation, distToRoads, distToRiver, getRiverInfo, riverWaterElevation, fbm, ridgeNoise, mulberry32, SIZE_DIMS } from './terrain.js?v=8';
import { getSeason, SEASON_STYLE, getDayPhase, PHASES, MOODS, fetchWeather } from './ambience.js?v=8';
import { Surfaces, waterNormalTexture, textures, material, createBotanicalFoliageMaterial, clearCache } from './materials.js?v=8';
import { icon, speciesIcon, speciesKey } from './icons.js?v=8';
import { charityName } from './catalog.js?v=8';
import { DRONE_TOUR_LANDMARKS } from './tour.js?v=8';
import { buildGrandBoulevard, buildSecondaryRoad } from './roads.js?v=8';

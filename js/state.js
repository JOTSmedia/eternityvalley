...
// ============================================================
import { IS_DEMO, IS_ADMIN, FIREBASE_CONFIG } from './config.js?v=6';
import { MEMBERSHIPS } from './catalog.js?v=6';
...
export const State = {
  ...
  async init(user) {
    ...
    try {
      const appMod = await import('https://www.gstatic.com/firebasejs/10.12.2/firebase-app.js?v=6');
      fs = await import('https://www.gstatic.com/firebasejs/10.12.2/firebase-firestore.js?v=6');

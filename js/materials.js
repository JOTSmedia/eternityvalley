...
export const Surfaces = {
  ...
  stainedGlassRose: () => {
    ...
    return material('stainedGlassRose', {
      ...
      transparent: true,
      side: THREE.DoubleSide,
      roughness: 0.05, metalness: 0.0, physical: true, transmission: 0.95, thickness: 2.5, ior: 1.54, dispersion: 0.024, clearcoat: 1.0, clearcoatRoughness: 0.02,
      emissive: 0xffffff,
  ...
  glass: () => new THREE.MeshPhysicalMaterial({
    color: 0xffffff, roughness: 0.03, metalness: 0.02, transmission: 0.96,
    thickness: 1.2, ior: 1.5, transparent: true, clearcoat: 1, clearcoatRoughness: 0.02,
    attenuationColor: new THREE.Color(0xd0f0ff), attenuationDistance: 10.0, envMapIntensity: 1.5,
  }),
  crystal: () => new THREE.MeshPhysicalMaterial({
    color: 0x78dcfa, roughness: 0.02, metalness: 0.05, transmission: 0.94,
    thickness: 2.5, ior: 1.54, transparent: true, clearcoat: 1.0, clearcoatRoughness: 0.02,
    attenuationColor: new THREE.Color(0x38bdf8), attenuationDistance: 8.0, envMapIntensity: 1.6,
  }),
  prismaticCrystal: () => new THREE.MeshPhysicalMaterial({
    ...
    dispersion: 0.038,
    attenuationColor: new THREE.Color(0xdff0fa),
...
export function createBotanicalFoliageMaterial(color = 0x3d7045, alphaMap = null, options = {}) {
  ...
  const {
    ...
    normalMap = null,
    normalScale = 1.0,
    sssColor = new THREE.Color(isTree ? 0x82d835 : 0x8ce045),
    shadowColor = new THREE.Color(isTree ? 0x1a4414 : 0x143410),
    sssIntensity = isTree ? 0.88 : 0.75,
    windIntensity = 1.0,
    ...rest
  } = opts;

...
//     matMossBoulder.color.setHex(0x4a5d4e);
  ...
  _mountainWaterfall() {
    ...
    const fallPoints = [
      ...
      new V3(0, 178.0, -468),   // Channel narrows toward cliff lip
      new V3(0, 175.0, -450),   // Soaring over the great cataract cliff lip
      new V3(0, 138.0, -430),   // Free vertical fall begins
      new V3(0, 83.9, -405),    // Mid-cataract roaring spray
      new V3(0, 42.0, -385),    // Lower cataract churning curtain
      new V3(0, 24.0, -368),    // Base impact cascade
      new V3(0, 18.0, -360),    // Plunge pool water level
    ];

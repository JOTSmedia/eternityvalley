...
//     matMossBoulder.color.setHex(0x4a5d4e);
  ...
  _initTourSpline() {
    ...
    const tourPoints = [
      ...
      new THREE.Vector3(0, 48.0, 1040),   // 1: Lining up with the grand approach
      new THREE.Vector3(0, 37.5, 980),    // 2: Monumental approach on Grand Marble Esplanade
      new THREE.Vector3(0, 37.0, 930),    // 3: Gliding between classical torchiere colonnades
      new THREE.Vector3(0, 36.8, 880),    // 4: Flight straight through triumphal archway center
      new THREE.Vector3(0, 36.5, 820),    // 5: Passing inner gate colonnade
      new THREE.Vector3(0, 36.0, 700),    // 6: Gliding down imperial avenue

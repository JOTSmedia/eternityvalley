...
const isHigh = typeof window !== 'undefined' && window.innerWidth > 768 ? 1024 : 512;
  ...
  async _water() {
    ...
    const turtleData = [
      { cx: 15,  cy: -8.5, cz: 2225, radiusX: 35, radiusZ: 40, speed: 0.34, orbitSpeed: 0.046, scale: 2.6, phase: 0.3, color: [0.24, 0.46, 0.20] }, // Gliding at dive plunge entry
      { cx: -18, cy: -14.0, cz: 2275, radiusX: 42, radiusZ: 48, speed: 0.31, orbitSpeed: 0.042, scale: 2.7, phase: 1.6, color: [0.22, 0.44, 0.18] }, // Soaring along coral wall
      { cx: -35, cy: -18.5, cz: 2245, radiusX: 38, radiusZ: 42, speed: 0.33, orbitSpeed: 0.048, scale: 2.5, phase: 3.0, color: [0.26, 0.48, 0.22] }, // Mid-trench gliding
      { cx: 38,  cy: -12.0, cz: 2290, radiusX: 45, radiusZ: 50, speed: 0.28, orbitSpeed: 0.038, scale: 2.8, phase: 4.4, color: [0.20, 0.40, 0.16] }, // East coral garden
      { cx: -42, cy: -22.0, cz: 2330, radiusX: 52, radiusZ: 56, speed: 0.30, orbitSpeed: 0.040, scale: 2.6, phase: 2.1, color: [0.25, 0.45, 0.19] }, // Deep shelf channel
      { cx: 0,   cy: -26.0, cz: 2360, radiusX: 58, radiusZ: 64, speed: 0.27, orbitSpeed: 0.036, scale: 2.9, phase: 5.2, color: [0.23, 0.47, 0.21] }, // Deep lagoon trench
      { cx: -45, cy: -6.5, cz: 1150, radiusX: 55, radiusZ: 65, speed: 0.33, orbitSpeed: 0.044, scale: 2.5, phase: 1.2, color: [0.22, 0.42, 0.18] },  // Coastal ocean reef
      { cx: 55,  cy: -7.5, cz: 1220, radiusX: 60, radiusZ: 70, speed: 0.29, orbitSpeed: 0.038, scale: 2.6, phase: 3.7, color: [0.24, 0.46, 0.20] },  // Coastal ocean reef
    ];
    ...
    const mantaData = [
      { cx: 10,  cy: -18.5, cz: 2235, radiusX: 45, radiusZ: 55, speed: 0.26, orbitSpeed: 0.028, scale: 3.2, phase: 0.6 }, // Soaring directly under dive plunge
      { cx: -20, cy: -24.0, cz: 2270, radiusX: 52, radiusZ: 60, speed: 0.24, orbitSpeed: 0.025, scale: 3.5, phase: 2.4 }, // Cruising 40m coral dropoff
      { cx: -38, cy: -28.5, cz: 2230, radiusX: 48, radiusZ: 56, speed: 0.25, orbitSpeed: 0.027, scale: 3.1, phase: 1.2 }, // Gliding along deep canyon wall
      { cx: 32,  cy: -32.0, cz: 2285, radiusX: 58, radiusZ: 66, speed: 0.22, orbitSpeed: 0.022, scale: 3.4, phase: 4.6 }, // Deep abyss floor
      { cx: -45, cy: -12.0, cz: 1240, radiusX: 85, radiusZ: 95, speed: 0.22, orbitSpeed: 0.024, scale: 3.0, phase: 0.0 }, // Coastal ocean abyss
      { cx: 55,  cy: -14.5, cz: 1300, radiusX: 90, radiusZ: 100, speed: 0.20, orbitSpeed: 0.022, scale: 3.2, phase: 3.5 }, // Coastal ocean abyss
    ];
...
//     matMossBoulder.color.setHex(0x4a5d4e);
  ...
  _initTourSpline() {
    ...
    const tourPoints = [
      ...
      new THREE.Vector3(-25, -16.0, 2240), // 80: Submarine abyss glide among manta rays & sharks
  ...
  _calculateTourLookTarget(t, pos, tangent, outTarget) {
    ...
    if (normT < 1.0) {
      if (normT < 10 * S + S * 0.1) {
        ...
        target.set(-25.0 + (-20.0 - -25.0) * frac, -16.0 + (-8.0 - -16.0) * frac, 2280.0 + (2200.0 - 2280.0) * frac);
      } else if (normT < 10 * S + S * 0.3) {
        const frac = smooth((normT - (10 * S + S * 0.1)) / (S * 0.2));
        target.set(-20.0 + (-80.0 - -20.0) * frac, -8.0 + (75.0 - -8.0) * frac, 2200.0 + (1600.0 - 2200.0) * frac);

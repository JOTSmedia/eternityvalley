...
import { WorldAssetLoader } from './WorldAssetLoader.js';
import { WorldLighting } from './WorldLighting.js';
import { WorldTerrain } from './WorldTerrain.js';
import { WorldTourController } from './WorldTourController.js';
...
//     matMossBoulder.color.setHex(0x4a5d4e);
  ...
  _animate() {
    ...
    try {
      ...
      if (now - this._lastFpsHudUpdate >= 200 && this._fpsCount >= 5) {
        ...
        if (!this._drsInitialized) {
          ...
          this._drsPixelRatio = isMob ? 1.25 : Math.min(window.devicePixelRatio || 1.0, 1.0);
    ...
    if (this.scene.fog) {
      ...
      console.log('[world3d] _animate error in frame, falling back to direct render:', err.stack || err);
      try {

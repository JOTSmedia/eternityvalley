...
//     matMossBoulder.color.setHex(0x4a5d4e);
  ...
  _animate() {
    ...
    if (this.terrain._gateLeft && this.terrain._gateRight) {
      ...
      this.terrain._gateLeft.rotation.y = this.terrain.gateOpenAmount * -1.85;
      // Swing open inward toward the valley (PI + 1.48 rad)
      this.terrain._gateRight.rotation.y = Math.PI + this.terrain.gateOpenAmount * 1.85;
    }

...
export class WorldTourController {
  ...
  _initTourSpline() {
    ...
    const tourPoints = [
      // 1. GATE
      new THREE.Vector3(0, 50.0, 1300),
      new THREE.Vector3(0, 36.5, 885),
      ...
      // 3. PLAZA
      new THREE.Vector3(80, 140.0, 50),
      new THREE.Vector3(-80, 150.0, -100),

      // 4. WATERFALL
      new THREE.Vector3(-20, 140.0, -300),
      new THREE.Vector3(0, 260.0, -480),

      // 5. TARN
      new THREE.Vector3(0, 290.0, -560),
      new THREE.Vector3(40, 310.0, -600),

      // 6. CATHEDRAL
      new THREE.Vector3(-100, 360.0, -700),
      new THREE.Vector3(-200, 330.0, -550),

      // 7. MOSQUE
      new THREE.Vector3(-350, 240.0, -350),
      new THREE.Vector3(-500, 210.0, -150),
      ...
      // 9. PAGODA
      new THREE.Vector3(450, 310.0, -350),
      new THREE.Vector3(580, 340.0, -550),

      // 10. KAYA ISLAND
      new THREE.Vector3(400, 220.0, 800),
      new THREE.Vector3(100, 140.0, 2100),

...
export class WorldTourController {
  ...
  _initTourSpline() {
    ...
    const tourPoints = [
      ...
      new THREE.Vector3(100, 48.0, 950),   // 73: Open coastal flight
      new THREE.Vector3(20, 48.0, 1800),   // 74: Approach Kaya Island
      new THREE.Vector3(70, 48.0, 2100),   // 75: Eastward orbit around Kaya Statue Orb (x:20, z:2100)
      new THREE.Vector3(20, 48.0, 2150),   // 76: Southward orbit around Kaya Statue Orb
      new THREE.Vector3(-30, 48.0, 2100),  // 77: Westward orbit completion
  ...
  _updateWalk(dt) {
    ...
    if (this.tourMode) {
      ...
      if (!this.world._currentLook || isNaN(this.world._currentLook.x) || isNaN(this.world._currentLook.y) || isNaN(this.world._currentLook.z)) {
        this.world._currentLook = this.world._currentLook || new THREE.Vector3();
        this.world._currentLook.copy(this.world._v3TourLook);
      }
      ...
      const viewDir = this.world._v3Tmp3.subVectors(this.world._currentLook, this.world._v3TourPos);
      if (viewDir.lengthSq() < 0.0001) viewDir.set(0, 0, -1);
      else viewDir.normalize();
      this.world.camera.up.set(0, 1, 0).applyAxisAngle(viewDir, this.world._currentRoll);

...
// ============================================================
import { GOOGLE_MAPS_API_KEY, HAS_MAPS3D } from './config.js?v=9';
import { RBV } from './social.js?v=9';
import { icon as uiIcon, speciesIcon, speciesKey, rainbowMark } from './icons.js?v=9';
...
export class EarthView {
  ...
  async _loadLeaflet() {
    ...
    await new Promise((res, rej) => {
      ...
      s.src = 'https://unpkg.com/leaflet@1.9.4/dist/leaflet.js?v=9';

...
export function mergeGeometries(geometries, useGroups = false) {
  ...
  try {
    // Filter out null or invalid geometries
    ...
    normalized.forEach((g, i) => { if (g && g !== validGeos[i]) g.dispose(); });
    return merged;
  } catch (err) {
...
export const safeMerge = mergeGeometries;
...
const isHigh = typeof window !== 'undefined' && window.innerWidth > 768 ? 1024 : 512;
  ...
  async _water() {
    ...
    const troutSchools = [
      ...
      { cx: 0,   cy: 161.5, cz: -535, radiusX: 38, radiusZ: 32, count: 28, type: 'abyssal_trout' },  // Deep Submerged Granite Floor (20.5m below surface)
      { cx: 16,  cy: 165.0, cz: -515, radiusX: 34, radiusZ: 36, count: 28, type: 'abyssal_trout' },  // Deep Basin Gliders (17m below surface)
      { cx: -18, cy: 169.0, cz: -540, radiusX: 32, radiusZ: 30, count: 28, type: 'glacial_trout' },  // Mid-depth Emerald Alpine Brook Trout (13m below surface)
      { cx: 8,   cy: 172.5, cz: -495, radiusX: 32, radiusZ: 34, count: 26, type: 'glacial_trout' },  // Mid-depth North Channel Brook Trout (9.5m below surface)
      { cx: -15, cy: 175.5, cz: -520, radiusX: 30, radiusZ: 28, count: 24, type: 'sapphire_gliders' }, // West Cathedral Shoreline & Cavern Gliders (6.5m below surface)
      { cx: 12,  cy: 177.0, cz: -545, radiusX: 28, radiusZ: 26, count: 22, type: 'sapphire_gliders' }, // East Cathedral Submerged Shelf (5m below surface)
      { cx: 0,   cy: 179.5, cz: -475, radiusX: 26, radiusZ: 26, count: 22, type: 'rapids_trout' },   // Shallow Waterfall Outflow Lip & Rapids (2.5m below surface)

      // 2. Mountain Waterfall Plunge Pool & Grotto (Base of Waterfall, waterLevel = 18.0m, deep bed at 4.5m -> 13.5m deep!)
      { cx: 0,   cy: 7.5,   cz: -362, radiusX: 34, radiusZ: 34, count: 26, type: 'grotto_trout' },   // Deep Churning Grotto Basin (10.5m below surface)
      { cx: 16,  cy: 11.5,  cz: -355, radiusX: 30, radiusZ: 32, count: 24, type: 'grotto_trout' },   // Mid-Grotto Basin (6.5m below surface)
      { cx: -14, cy: 14.5,  cz: -365, radiusX: 28, radiusZ: 30, count: 22, type: 'cascade_gliders' }, // Cascade Mist Swirlers (3.5m below surface)
    ...
    const koiSchools = [
      ...
      { cx: 430, cy: -0.5, cz: -260, radiusX: 115, radiusZ: 125, count: 45, type: 'sovereign_koi' }, // Deepest Basin Kohaku Ruby & 24K Gold Emperors (13m below surface)
      { cx: 460, cy: 2.5,  cz: -280, radiusX: 105, radiusZ: 115, count: 48, type: 'sovereign_koi' }, // Deep Basin Pelagic Emperors (10m below surface)
      { cx: 410, cy: 5.5,  cz: -240, radiusX: 105, radiusZ: 115, count: 42, type: 'golden_koi' },    // Mid-Depth Yamabuki & Platinum Ogon (7m below surface)
      { cx: 330, cy: 7.8,  cz: -200, radiusX: 85,  radiusZ: 95,  count: 38, type: 'golden_koi' },    // Western Lotus Sanctuary & Driftwood Shallows (4.7m below surface)
      { cx: 450, cy: 8.2,  cz: -380, radiusX: 95,  radiusZ: 100, count: 40, type: 'lake_trout' },    // Northern Alpine Mountain Reflection Shoal (4.3m below surface)
      { cx: 530, cy: 8.8,  cz: -250, radiusX: 85,  radiusZ: 90,  count: 35, type: 'golden_koi' },    // Eastern Forest Shoreline (3.7m below surface)
      { cx: 370, cy: 9.5,  cz: -120, radiusX: 75,  radiusZ: 85,  count: 34, type: 'river_gliders' }, // Southern River Outlet Bay (3m below surface)
    ];
    ...
    const reefSchools = [
      ...
      { cx: 35,  cy: -3.8, cz: 2210, radiusX: 65, radiusZ: 75, count: 55, type: 'reef_clownfish' }, // Coral Clownfish & Anthias
      { cx: -25, cy: -4.5, cz: 2250, radiusX: 70, radiusZ: 80, count: 60, type: 'reef_tangs' },      // Lemon Yellow Tangs & Moorish Idols
      { cx: -55, cy: -5.2, cz: 2280, radiusX: 60, radiusZ: 68, count: 50, type: 'reef_beauties' },   // Mint Wrasses & Coral Beauties

      // Mid-Depth Gorgonian Wall & Marine Shelf (y = -14.0m to -22.0m)
      { cx: 20,  cy: -16.5, cz: 2320, radiusX: 95, radiusZ: 110, count: 65, type: 'reef_tangs' },    // Neon Azure Tangs & Blue Damselfish
      { cx: -45, cy: -18.2, cz: 2360, radiusX: 90, radiusZ: 100, count: 55, type: 'reef_clownfish' },// Magenta Anthias & Coral Firefish

      // Deep 40-Meter Oceanic Abyss & Submarine Trench (y = -28.0m to -38.0m)
      { cx: 0,   cy: -32.0, cz: 2390, radiusX: 135, radiusZ: 155, count: 60, type: 'pelagic_jacks' },// Pelagic Sapphire Jacks & Silver Sea Kings
      { cx: 85,  cy: -36.5, cz: 2460, radiusX: 125, radiusZ: 140, count: 45, type: 'pelagic_jacks' },// Abyssal Canyon Trevallies
      
      // Extreme Abyssal Volumes (-60m to -126m)
      { cx: 20,  cy: -65.0, cz: 2500, radiusX: 140, radiusZ: 160, count: 80, type: 'pelagic_jacks' },// Midnight Zone Patrols
      { cx: -40, cy: -95.0, cz: 2550, radiusX: 150, radiusZ: 180, count: 85, type: 'pelagic_jacks' },// Twilight Depths
      { cx: 60,  cy: -120.0, cz: 2600, radiusX: 180, radiusZ: 200, count: 100, type: 'pelagic_jacks' },// Hadal Floor Schools

      // Coastal Ocean Lagoon (z = 980 to 1420)
      { cx: 65,  cy: -6.5, cz: 1180, radiusX: 85, radiusZ: 95, count: 40, type: 'reef_clownfish' },
      { cx: -60, cy: -8.0, cz: 1320, radiusX: 90, radiusZ: 100, count: 35, type: 'reef_tangs' },
    ];
    ...
    const mantaData = [
      { cx: 10,  cy: -18.5, cz: 2235, radiusX: 45, radiusZ: 55, speed: 0.26, orbitSpeed: 0.028, scale: 3.2, phase: 0.6, dir: 1 }, // Soaring directly under dive plunge
      { cx: -20, cy: -24.0, cz: 2270, radiusX: 52, radiusZ: 60, speed: 0.24, orbitSpeed: 0.025, scale: 3.5, phase: 2.4, dir: -1 }, // Cruising 40m coral dropoff
      { cx: -38, cy: -28.5, cz: 2230, radiusX: 48, radiusZ: 56, speed: 0.25, orbitSpeed: 0.027, scale: 3.1, phase: 1.2, dir: 1 }, // Gliding along deep canyon wall
      { cx: 32,  cy: -32.0, cz: 2285, radiusX: 58, radiusZ: 66, speed: 0.22, orbitSpeed: 0.022, scale: 3.4, phase: 4.6, dir: -1 }, // Deep abyss floor
      { cx: -45, cy: -12.0, cz: 1240, radiusX: 85, radiusZ: 95, speed: 0.22, orbitSpeed: 0.024, scale: 3.0, phase: 0.0, dir: 1 }, // Coastal ocean abyss
      { cx: 55,  cy: -14.5, cz: 1300, radiusX: 90, radiusZ: 100, speed: 0.20, orbitSpeed: 0.022, scale: 3.2, phase: 3.5, dir: -1 }, // Coastal ocean abyss
    ];
...
//     tarnBoulderMat.roughness = 0.35;
    ...
    const matMassiveCoral = Surfaces.massiveCoral ? Surfaces.massiveCoral() : new THREE.MeshStandardMaterial({color: 0x883355, roughness: 0.8});
    ...
    const matAbyssRock = Surfaces.seabedRock ? Surfaces.seabedRock() : new THREE.MeshStandardMaterial({color: 0x334455, roughness: 0.9});
    ...
    const matAbyssAnemone = Surfaces.anemone ? Surfaces.anemone() : new THREE.MeshStandardMaterial({color: 0x33ffcc, emissive: 0x118866});
    ...
    const matBioPlant = Surfaces.bioluminescentPlant ? Surfaces.bioluminescentPlant() : new THREE.MeshStandardMaterial({color: 0x00ffaa, emissive: 0x00ffaa, emissiveIntensity: 1.5});
    ...
    // =========================================================================
    // 10.6 Crustaceans (Crabs, Lobsters, Shrimp) on Coral Reef & Ocean Floor
    // =========================================================================
    const buildCrabGeometry = () => {
      const parts = [];
      const body = new THREE.CylinderGeometry(0.3, 0.25, 0.15, 8);
      body.scale(1, 0.5, 0.7);
      parts.push(body);
      const clawL = new THREE.BoxGeometry(0.2, 0.1, 0.25);
      clawL.translate(-0.35, 0, 0.25);
      clawL.rotateY(0.4);
      const clawR = new THREE.BoxGeometry(0.2, 0.1, 0.25);
      clawR.translate(0.35, 0, 0.25);
      clawR.rotateY(-0.4);
      parts.push(clawL, clawR);
      for (let i = 0; i < 3; i++) {
        const legL = new THREE.CylinderGeometry(0.02, 0.02, 0.4);
        legL.rotateZ(1.2);
        legL.translate(-0.3, 0, -0.1 - i * 0.1);
        const legR = new THREE.CylinderGeometry(0.02, 0.02, 0.4);
        legR.rotateZ(-1.2);
        legR.translate(0.3, 0, -0.1 - i * 0.1);
        parts.push(legL, legR);
      }
      return safeMerge(parts, false) || body;
    };
    
    const buildLobsterGeometry = () => {
      const parts = [];
      const body = new THREE.CylinderGeometry(0.15, 0.2, 0.8, 7);
      body.rotateX(Math.PI / 2);
      parts.push(body);
      const tail = new THREE.BoxGeometry(0.2, 0.05, 0.3);
      tail.translate(0, -0.05, -0.45);
      parts.push(tail);
      const clawL = new THREE.BoxGeometry(0.15, 0.1, 0.35);
      clawL.translate(-0.25, 0, 0.5);
      clawL.rotateY(0.2);
      const clawR = new THREE.BoxGeometry(0.2, 0.15, 0.45);
      clawR.translate(0.25, 0, 0.5);
      clawR.rotateY(-0.2);
      parts.push(clawL, clawR);
      return safeMerge(parts, false) || body;
    };

    const buildShrimpGeometry = () => {
      const parts = [];
      const body = new THREE.CylinderGeometry(0.06, 0.08, 0.4, 6);
      body.rotateX(Math.PI / 2);
      const tail = new THREE.ConeGeometry(0.08, 0.2, 6);
      tail.rotateX(-Math.PI / 2);
      tail.translate(0, 0, -0.25);
      parts.push(body, tail);
      return safeMerge(parts, false) || body;
    };

    const geoCrab = buildCrabGeometry();
    const geoLobster = buildLobsterGeometry();
    const geoShrimp = buildShrimpGeometry();

    const matCrab = new THREE.MeshStandardMaterial({ color: 0xe04030, roughness: 0.8, metalness: 0.1 });
    const matLobster = new THREE.MeshStandardMaterial({ color: 0x3b5998, roughness: 0.6, metalness: 0.3 });
    const matShrimp = new THREE.MeshStandardMaterial({ color: 0xffa07a, roughness: 0.4, transparent: true, opacity: 0.85 });

    const crabCount = 180;
    const lobsterCount = 120;
    const shrimpCount = 300;
    
    const crabMesh = new THREE.InstancedMesh(geoCrab, matCrab, crabCount);
    const lobsterMesh = new THREE.InstancedMesh(geoLobster, matLobster, lobsterCount);
    const shrimpMesh = new THREE.InstancedMesh(geoShrimp, matShrimp, shrimpCount);

    const placeCrustaceans = (mesh, count, scaleBase) => {
      for (let i = 0; i < count; i++) {
        let ax, az;
        if (coralRng() > 0.4) {
          ax = (coralRng() - 0.5) * 340;
        ...
        if (ay > -1.0) {
          ...
          const s = scaleBase * (0.8 + coralRng() * 0.4);
          initDummy.position.set(ax, ay + 0.1, az);
          const nx = terrainHeight(ax + 0.1, az) - ay;
          const nz = terrainHeight(ax, az + 0.1) - ay;
          initDummy.rotation.set(-nz * 10.0, coralRng() * Math.PI * 2, nx * 10.0);
          initDummy.scale.set(s, s, s);
        }
        initDummy.updateMatrix();
        mesh.setMatrixAt(i, initDummy.matrix);
    ...
    placeCrustaceans(crabMesh, crabCount, 1.2);
    placeCrustaceans(lobsterMesh, lobsterCount, 1.5);
    placeCrustaceans(shrimpMesh, shrimpCount, 0.8);
    
    this._crabMesh = crabMesh;
    this._lobsterMesh = lobsterMesh;
    this._shrimpMesh = shrimpMesh;
...
//     wetRockMat.roughness = 0.25;
  ...
  _mountainWaterfall() {
    ...
    const upperTarnGeo = new THREE.PlaneGeometry(124, 118, 48, 48);
    ...
    upperTarnMesh.position.set(0, 182.0, -515);
...
#include <logdepthbuf_vertex>
  ...
  _updateUnderwater(dt, t) {
    ...
    updateFlock(this._turtleData, this._turtleMesh);
    ...
    // Crustaceans animation (subtle swaying and crawling)
    if (this._crabMesh || this._lobsterMesh || this._shrimpMesh) {
      const mat = new THREE.Matrix4();
      const pos = new THREE.Vector3();
      const quat = new THREE.Quaternion();
      const scale = new THREE.Vector3();
      
      const updateCrustacean = (mesh, speed, swayAmp) => {
        if (!mesh) return;
        ...
        for (let i = 0; i < count; i++) {
          ...
          const phase = i * 1.23;
          pos.x += Math.sin(t * speed + phase) * 0.005;
          pos.z += Math.cos(t * speed * 0.8 + phase) * 0.005;
          
          const euler = new THREE.Euler().setFromQuaternion(quat);
          euler.y += Math.sin(t * speed * 1.5 + phase) * swayAmp;
      ...
      updateCrustacean(this._crabMesh, 0.5, 0.002);
      updateCrustacean(this._lobsterMesh, 0.3, 0.001);
      updateCrustacean(this._shrimpMesh, 1.2, 0.005);
    }
  }
  _underwaterWorld() {}
  // ============================================================
...
//     cherryBark.color.setHex(0x382820);
  ...
  async _meadowCarpet() {
    ...
    const isMobile = typeof window !== 'undefined' && window.innerWidth <= 768;
    const numGrass = isMobile ? 30000 : 150000;
    const numFlowers = isMobile ? 5000 : 25000;
    ...
    for (let i = 0; i < numGrass; i++) {
      ...
      if (Math.hypot(x - WORLD.plaza.x, z - WORLD.plaza.z) < WORLD.plaza.r + 32) continue;
      if (Math.hypot(x - WORLD.gate.x, z - WORLD.gate.z) < 140) continue;
      if (Math.abs(x) < 56 && z >= 760 && z <= 1120) continue; // keep Grand Gate corridor clear
      if (Math.hypot(x - WORLD.bridge.x, z - WORLD.bridge.z) < 140) continue;
...
//     if (palmBark && palmBark.color) palmBark.color.setHex(0xa88e6e);
    ...
    const sunGlowMat = new THREE.MeshStandardMaterial({ color: 0xffd700, emissive: 0xffaa24, emissiveIntensity: 1.8, roughness: 0.2, metalness: 0.8 });
    ...
    for (let s = 0; s < stepCount; s++) {
      const stepGeo = new THREE.BoxGeometry(18, 4.35, 1.4);
      stepGeo.translate(0, 0.18 + s * 0.30 - 2.0, 27.5 - s * 0.75);
  ...
  async _universalCathedral() {
    ...
    // Massive Cathedral Carrara Marble Floor Foundation
    const marbleFloorMat = material('honedCarraraMarble', { repeat: 4.0, color: 0xffffff, roughness: 0.1, metalness: 0.05 });
    const cathFloor = new THREE.Mesh(new THREE.BoxGeometry(70, 36.0, 120), marbleFloorMat);
    cathFloor.position.set(0, -17.5, 0); // Grounded deeply into the terrain, top surface exactly matches nave floor
    cathFloor.receiveShadow = cathFloor.castShadow = true;
    g.add(cathFloor);
...
//     gold.clearcoatRoughness = 0.1;
    ...
    const byzantineMosaic = material('byzantineMosaic', { repeat: 12.0, color: 0xffffff, roughness: 0.2, metalness: 0.1 }); // Add mosaic
    ...
    for (let st = 0; st < 6; st++) {
      const stepMesh = new THREE.Mesh(new THREE.BoxGeometry(1.6, 4.22, 16 - st * 1.2), stone);
      stepMesh.position.set(-47.2 - st * 0.8, 0.2 + st * 0.32 - 2.0, -4);
    ...
    for (let st = 0; st < 10; st++) {
      ...
      const stepMesh = new THREE.Mesh(new THREE.BoxGeometry(stepWidth, 4.22, stepDepth), stone);
      stepMesh.position.set(0, stepY - 2.0, stepZ);
      stepMesh.receiveShadow = stepMesh.castShadow = true;
      g.add(stepMesh);
    }
    ...
    [-20, 20].forEach((tx, ti) => {
      ...
      [[-7.2, 7.2], [-7.2, -7.2], [7.2, 7.2], [7.2, -7.2]].forEach(([bx, bz]) => {
        ...
        buttressCap.castShadow = true; buttressCap.receiveShadow = true;
      ...
      cornice1.castShadow = true; cornice1.receiveShadow = true;
      ...
      [0, Math.PI / 2, Math.PI, -Math.PI / 2].forEach(ang => {
        ...
        nicheCorbel.castShadow = true; nicheCorbel.receiveShadow = true;
        ...
        canopyGable.castShadow = true; canopyGable.receiveShadow = true;
        ...
        statueBody.castShadow = true; statueBody.receiveShadow = true;
      ...
      cornice2.castShadow = true; cornice2.receiveShadow = true;
      ...
      belfryPiers.castShadow = true; belfryPiers.receiveShadow = true;
      ...
      bellDome.castShadow = true; bellDome.receiveShadow = true;
      ...
      [[-6.8, 6.8], [-6.8, -6.8], [6.8, 6.8], [6.8, -6.8]].forEach(([gx, gz]) => {
        ...
        gargoyle.castShadow = true; gargoyle.receiveShadow = true;
      ...
      spireBaseOct.castShadow = true; spireBaseOct.receiveShadow = true;
      ...
      spireNeedle.castShadow = true; spireNeedle.receiveShadow = true;
    ...
    portalLintel.castShadow = true; portalLintel.receiveShadow = true;
    g.add(portalLintel);
    ...
    portalInnerArch.castShadow = true; portalInnerArch.receiveShadow = true;
...
//     bogOak.metalness = 0.04;
    ...
    [-1, 1].forEach((sign) => {
      ...
      stileHinge.castShadow = true; stileHinge.receiveShadow = true;
      ...
      stileMeeting.castShadow = true; stileMeeting.receiveShadow = true;
      ...
      [1.2, 3.6, 5.8].forEach((hy) => {
        ...
        pintle.castShadow = true; pintle.receiveShadow = true;
        ...
        [-0.13, 0.13].forEach((sz) => {
          ...
          strap.castShadow = true; strap.receiveShadow = true;
          doorGroup.add(strap);
    ...
    [-4.6, -3.8, 3.8, 4.6].forEach((jx) => {
      ...
      jStatue.castShadow = true; jStatue.receiveShadow = true;
    ...
    wimpergMesh.castShadow = true; wimpergMesh.receiveShadow = true;
    ...
    apexPin.castShadow = true; apexPin.receiveShadow = true;
    ...
    [-9.2, 9.2].forEach((px, pi) => {
      ...
      sideDoor.castShadow = true; sideDoor.receiveShadow = true;
      ...
      [-1.8, 1.8].forEach(sjx => {
        ...
        sideJamb.castShadow = true; sideJamb.receiveShadow = true;
    ...
    galleryBase.castShadow = true; galleryBase.receiveShadow = true;
    g.add(galleryBase);
    ...
    for (let k = -5; k <= 5; k++) {
      ...
      kStatue.castShadow = true; kStatue.receiveShadow = true;
      g.add(kStatue);
    ...
    galleryCorniceTop.castShadow = true; galleryCorniceTop.receiveShadow = true;
    ...
    facadeGable.castShadow = true; facadeGable.receiveShadow = true;
    ...
    corbelBase.castShadow = true; corbelBase.receiveShadow = true;
    ...
    for (let cb = -6; cb <= 6; cb++) {
      ...
      corbel.castShadow = true; corbel.receiveShadow = true;
    ...
    nichePositions.forEach((nx, ni) => {
      ...
      nStatue.castShadow = true; nStatue.receiveShadow = true;
    ...
    apexPinnacle.castShadow = true; apexPinnacle.receiveShadow = true;
    ...
    apexSpirelet.castShadow = true; apexSpirelet.receiveShadow = true;
    ...
    naveWallL_Top.castShadow = true; naveWallL_Top.receiveShadow = true;
    g.add(naveWallL_Top);
    ...
    naveWallR_Top.castShadow = true; naveWallR_Top.receiveShadow = true;
    g.add(naveWallR_Top);
    ...
    aisleWallL_Top.castShadow = true; aisleWallL_Top.receiveShadow = true;
    ...
    aisleWallR_Top.castShadow = true; aisleWallR_Top.receiveShadow = true;
    ...
    transeptRoofNorth.castShadow = true; transeptRoofNorth.receiveShadow = true;
    ...
    transeptRoofSouth.castShadow = true; transeptRoofSouth.receiveShadow = true;
    ...
    [-34.2, 34.2].forEach(tx => {
      ...
      tGable.castShadow = true; tGable.receiveShadow = true;
      ...
      [3.8, 4.5, 5.2].forEach((rad, ri) => {
        ...
        tArchivolt.castShadow = true; tArchivolt.receiveShadow = true;
        g.add(tArchivolt);
      });
      ...
      [-8.0, 0.0].forEach(jz => {
        ...
        jCol.castShadow = true; jCol.receiveShadow = true;
        g.add(jCol);
    ...
    apseRoof.castShadow = true; apseRoof.receiveShadow = true;
    g.add(apseRoof);
    ...
    for (let cp = 0; cp < 5; cp++) {
      ...
      chapelRoof.castShadow = true; chapelRoof.receiveShadow = true;
      g.add(chapelRoof);
    ...
    buttressZPlacements.forEach(bz => {
      [-23.5, 23.5].forEach(bx => {
        ...
        pierBase.castShadow = true; pierBase.receiveShadow = true;
        ...
        pierMid.castShadow = true; pierMid.receiveShadow = true;
        ...
        pierTop.castShadow = true; pierTop.receiveShadow = true;
        ...
        pinShaft.castShadow = true; pinShaft.receiveShadow = true;
        ...
        pinSpire.castShadow = true; pinSpire.receiveShadow = true;
        ...
        upperFlyer.castShadow = true; upperFlyer.receiveShadow = true;
        ...
        lowerFlyer.castShadow = true; lowerFlyer.receiveShadow = true;
        ...
        flyerStrut.castShadow = true; flyerStrut.receiveShadow = true;
        ...
        gargoyleSpout.castShadow = true; gargoyleSpout.receiveShadow = true;
    ...
    flecheBase.castShadow = true; flecheBase.receiveShadow = true;
    ...
    lanternStage1.castShadow = true; lanternStage1.receiveShadow = true;
    ...
    lanternStage2.castShadow = true; lanternStage2.receiveShadow = true;
    ...
    needleSpire.castShadow = true; needleSpire.receiveShadow = true;
    ...
    marble.polygonOffset = true;
    marble.polygonOffsetFactor = -1.0;
    marble.polygonOffsetUnits = -1.0;
    ...
    for (let pz = -22; pz <= 26; pz += 4.6) {
      [-5.6, 5.6].forEach(px => {
        ...
        endL.castShadow = true; endL.receiveShadow = true;
        pewGroup.add(endL);

        const endR = new THREE.Mesh(pewEndGeo, darkWood);
        endR.position.set(2.6, 0.8, 0);
        endR.castShadow = true; endR.receiveShadow = true;
        pewGroup.add(endR);
    ...
    altarTable.castShadow = true; altarTable.receiveShadow = true;
    ...
    reredos.castShadow = true; reredos.receiveShadow = true;
  ...
  _buddhistPagoda() {
    ...
    mossMat.polygonOffsetFactor = -1.0;
    mossMat.polygonOffsetUnits = -1.0;
    ...
    const tWater = new THREE.Mesh(new THREE.CircleGeometry(0.55, 16), this.world._waterPoolMat || new THREE.MeshStandardMaterial({
...
//     gold.clearcoatRoughness = 0.1;
    ...
    zellij.polygonOffset = true;
    zellij.polygonOffsetFactor = -1.0;
    zellij.polygonOffsetUnits = -1.0;
    ...
    const poolWater = new THREE.Mesh(poolWaterGeo, this.world._waterPoolMat || new THREE.MeshStandardMaterial({
    ...
    [-poolLength / 2 + 1.8, poolLength / 2 - 1.8].forEach(fz => {
      ...
      const fWater = new THREE.Mesh(new THREE.SphereGeometry(1.1, 16, 10, 0, Math.PI * 2, 0, Math.PI * 0.45), this.world._waterPoolMat || new THREE.MeshStandardMaterial({
  ...
  _plaza() {
    ...
    for (let i = 0; i < 8; i++) {
      ...
      planterGroup.position.set(-Math.sin(cornerAng) * 26.0, 4.0, Math.cos(cornerAng) * 26.0);
      ...
      const rng = mulberry32(12345 + Math.floor(ang * 1000));
    ...
    // 9. Breathtaking Grand Circular Colonnade and Dome Pavilion (The Plaza Interior)
    const pavilionGeos = [];
    const stainedGlassGeos = [];
    const mosaicGeos = [];
    const numCols = 16;
    const colRadius = 29.0;
    const archHeight = 24.0;
    const colHeight = 16.0;

    // Colossal Stained Glass Dome
    const domeGeo = new THREE.SphereGeometry(30, 64, 32, 0, Math.PI * 2, 0, Math.PI / 2);
    domeGeo.translate(0, archHeight, 0);
    stainedGlassGeos.push(domeGeo);

    // Ring of Columns and Grand Arches
    for (let i = 0; i < numCols; i++) {
      const ang = (i / numCols) * Math.PI * 2;
      const colX = Math.cos(ang) * colRadius;
      const colZ = Math.sin(ang) * colRadius;

      // Marble Column shaft
      const colGeo = new THREE.CylinderGeometry(1.2, 1.4, colHeight, 16);
      colGeo.translate(colX, colHeight / 2 + 1.6, colZ);
      pavilionGeos.push(colGeo);

      // Arch connecting columns
      const nextAng = ((i + 1) / numCols) * Math.PI * 2;
      const nx = Math.cos(nextAng) * colRadius;
      const nz = Math.sin(nextAng) * colRadius;
      
      const dist = Math.hypot(nx - colX, nz - colZ);
      const archProfile = new THREE.Shape();
      archProfile.moveTo(-dist/2, 0);
      archProfile.lineTo(-dist/2, 2.5);
      archProfile.quadraticCurveTo(0, 9.5, dist/2, 2.5);
      archProfile.lineTo(dist/2, 0);
      archProfile.lineTo(-dist/2, 0);

      const extrudeSettings = { depth: 1.5, bevelEnabled: false };
      const archMesh = new THREE.ExtrudeGeometry(archProfile, extrudeSettings);
      
      const midX = (colX + nx) / 2;
      const midZ = (colZ + nz) / 2;
      const archRot = Math.atan2(nz - colZ, nx - colX);
      
      archMesh.rotateY(-archRot);
      archMesh.translate(midX, colHeight + 1.6, midZ);
      pavilionGeos.push(archMesh);

      // Stained glass window panel within the arch
      const glassGeo = new THREE.PlaneGeometry(dist * 0.85, 7.5);
      glassGeo.translate(0, 4.0, 0);
      glassGeo.rotateY(-archRot);
      glassGeo.translate(midX, colHeight + 1.6, midZ);
      stainedGlassGeos.push(glassGeo);

      // Interior floating chandelier light
      const chL = new THREE.PointLight(0xffddaa, 1.5, 40, 1.5);
      chL.position.set(colX * 0.8, colHeight + 3.0, colZ * 0.8);
      g.add(chL);
    }

    // Intricate glowing mosaic cornice ring
    const domeBaseRing = new THREE.TorusGeometry(29, 1.2, 16, 64);
    domeBaseRing.rotateX(Math.PI / 2);
    domeBaseRing.translate(0, archHeight, 0);
    mosaicGeos.push(domeBaseRing);

    // High-performance batched safeMerge for Pavilion
    const mPavilion = safeMerge(pavilionGeos, false);
    if (mPavilion) {
      const pavMesh = new THREE.Mesh(mPavilion, marble);
      g.add(pavMesh);
    }
    const mStained = safeMerge(stainedGlassGeos, false);
    if (mStained) {
      const stMesh = new THREE.Mesh(mStained, Surfaces.stainedGlass ? Surfaces.stainedGlass() : material('ceramic'));
      g.add(stMesh);
    }
    const mMosaic = safeMerge(mosaicGeos, false);
    if (mMosaic) {
      const mosMesh = new THREE.Mesh(mMosaic, Surfaces.mosaic ? Surfaces.mosaic() : gold);
      g.add(mosMesh);
    }
...
//     soilMat.color.setHex(0x3e3224);
    ...
    const createBrazier = (scale = 1.0, isLeft = true) => {
      ...
      const rng = mulberry32(8888 + Math.floor(x + z));
      for (let ep = 0; ep < emberCount; ep++) {
        const theta = rng() * Math.PI * 2;
        const rad = rng() * 2.8 * scale;
        emberPos[ep * 3 + 0] = Math.cos(theta) * rad;
        emberPos[ep * 3 + 1] = (6.0 + rng() * 12.0) * scale;
    ...
    this.leftGateDoor = left;
    this.rightGateDoor = right;
...
//     darkBronze.metalness = 0.88;
  ...
  rebuildPlots() {
    ...
    for (let i = this.world.pickables.length - 1; i >= 0; i--) {
      ...
      if (this.world.plotMeshIndex.has(m)) {
    ...
    this._decorMeshes = [];
    this.world.plotMeshIndex.clear();
    this.world.scene.remove(this.world.selRing);
    console.log("[World3D] calling _plots()..."); this.world._plots(); console.log("[World3D] _plots() done");
  }

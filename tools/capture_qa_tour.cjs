...
async function main() {
  console.log("=== Starting Eternal Valley High-Res Visual QA & Pitch Validation ===");
  ...
  const outDirWorkspace = '/Users/bethrooney/Desktop/JOTS.MEDIA_AG/assets/qa/eternal_valley';

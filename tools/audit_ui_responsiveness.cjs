...
const OUTPUT_DIR = '/Users/bethrooney/Desktop/JOTS.MEDIA_AG/assets/qa/eternal_valley/responsiveness_audit';
...
async function runAudit() {
  console.log('===============================================================');
  console.log('  ETERNAL VALLEY UI/UX & RESPONSIVENESS TRIPLE-CHECK AUDIT    ');
  console.log('===============================================================');
